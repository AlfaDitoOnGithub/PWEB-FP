...
export default function Checkout() {
  ...
  const publishableKey =
    "pk_test_51OREzXCnFdD4jJwr8j6IC1RyxoXrJt5s6AJVfNbQMogMQU3K4cqwCRd1BkAe02LyfMRkQZhPaSMX1dD0B0oetQ7I00WRHRIDNP";
        ...
        <div className="px-4 pt-8">
          ...
          <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-5">
            {cartItems && cartItems.length ? (
              cartItems.map((item) => (
                <div
                  className="text-black flex flex-col rounded-lg bg-white sm:flex-row"
                  key={item._id}
                >
                  <img
